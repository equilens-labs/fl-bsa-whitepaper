...
\IdentityText{b04f721d789226723066b3d6ae70e4ab2a3fa17c825ef1d0e04d7d779571982b}; the source manifest
binds it to the exact v5.0.1 Gold artifact. It contains generated attributes, not names, contact
details, account identifiers, free text, credentials, or customer records.
...
\begin{enumerate}
  ...
  \item \textbf{Certificate content hashes and predecessor links} connect the 21 bundled
        certificates internally. The companion recomputes every stored hash and resolves 20 links
        to one root.

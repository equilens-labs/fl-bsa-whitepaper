...
smallest group has \RaceMinimumGroupN{} rows (\RaceMinimumGroupPct{}\%), below the configured 5\%
display floor. This display decision does not change the machine-readable calculation.
...
publication, the owner must choose either an explicitly archival characterization or a fresh
rebuild against an approved successor v5.0.2 tag and new evidence. As of 6 August 2026, no exact
v5.0.2 tag or evidence package exists; this paper must not be relabelled in advance.

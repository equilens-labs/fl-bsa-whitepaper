...
\begin{enumerate}
  ...
  \item v5.0.1 is security-superseded because its lock pins \texttt{cryptography} 49.0.0 in the
        CVE-2026-69247 affected range. Its disposition must resolve to an explicitly archival
        characterization or a fresh v5.0.2 tag and evidence rebuild; no such tag or evidence exists;

...
\begin{enumerate}
  ...
  \item v5.0.1 is security-superseded because its lock pins \texttt{cryptography} 49.0.0 in the
        CVE-2026-69247 affected range. Although v5.0.2 has fresh release evidence and the fixed
        dependency, its full Release workflow failed and it did not establish a published release.
        This artifact's disposition must therefore resolve to an explicitly archival v5.0.1
        characterization or retirement. Any current-release replacement must be separately rebuilt
        only after an exact product tag completes the full Release workflow and actually publishes;
        this paper cannot be relabelled or reused as successor evidence;
  ...
  \item customer-evidence and promotion dispositions remain false;
  \item production utility, broader protected-group coverage, near-duplicate privacy, calibration,
        ...
        and
  \item human reading-order and screen-reader review, plus an authorized publication-time
        accessibility decision, are required before declaring PDF/UA conformance.
\end{enumerate}

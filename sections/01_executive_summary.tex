...
The variation is material and limits any utility claim. \\
\end{tabular}
\end{KeyBox}
...
interval crosses 0.80; the amplification interval is entirely below it; and the intrinsic interval
is entirely above it. P-values and intervals remain conditional on one generated fixture and the

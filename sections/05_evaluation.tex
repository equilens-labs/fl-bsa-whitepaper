...
\begin{enumerate}
  ...
  \item the exact Gold merged summary and index for multi-seed characterization;
...
figures because the Hispanic group has 273 of 10,000 rows, below the configured 5\% display floor.
The paper still discloses the configured and effective reference groups, selection policy, worst
pair, minimum group count, and reason for suppression. Suppression is a presentation rule, not a
claim that the race result is favorable, immaterial, or absent.
